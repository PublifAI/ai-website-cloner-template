---
name: discover-site
description: Discover everything deterministic about a website — sitemap, performance, SEO/GEO signals, entity data, social links, raw HTML — then perceive its visual design from screenshots, then write a client-facing audit report. Three phases: Extract (scripts), Perceive (screenshots + vision), Report (synthesis). Required prerequisite for /clone-website. Triggers on "discover site", "get site structure", "site map", "crawl site", "audit site".
argument-hint: "<base-url> [--client <name>] [--phases 1,2,3] [--competitors <url1>,<url2>]"
user-invocable: true
---
